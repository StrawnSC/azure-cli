...
class TestFunctionappMocked(unittest.TestCase):
    ...
    def test_functionapp_zip_deploy_flow(
        self,
    ...
    def test_functionapp_linux_consumption_non_remote_build(
        self, is_plan_consumption_mock, upload_zip_to_storage_mock, parse_resource_id_mock, web_client_factory_mock
    ):
        # prepare
        cmd_mock = _get_test_cmd()
        cli_ctx_mock = mock.MagicMock()
    ...
    def test_enable_zip_deploy_remote_build_no_scm_site(self, get_scm_url_mock, get_site_credential_mock):
        # prepare
        cmd_mock = _get_test_cmd()
        cli_ctx_mock = mock.MagicMock()
        cmd_mock.cli_ctx = cli_ctx_mock
    ...
    def test_enable_zip_deploy_accepted(
        self, check_zip_deployment_status_mock, requests_post_mock, get_scm_url_mock, get_site_credential_mock
    ):
        # prepare
        cmd_mock = _get_test_cmd()
        cli_ctx_mock = mock.MagicMock()
        ...
        check_zip_deployment_status_mock.assert_called_with(
            cmd_mock, "rg", "name", "https://mock-scm/api/deployments/latest", mock.ANY, None
        )

    @mock.patch("azure.cli.command_modules.appservice.custom._get_site_credential", return_value=("usr", "pwd"))
    @mock.patch("azure.cli.command_modules.appservice.custom._get_scm_url", return_value="https://mock-scm")
    @mock.patch("requests.post", autospec=True)
    def test_enable_zip_deploy_conflict(self, requests_post_mock, get_scm_url_mock, get_site_credential_mock):
        # prepare
        cmd_mock = _get_test_cmd()
        cli_ctx_mock = mock.MagicMock()
        cmd_mock.cli_ctx = cli_ctx_mock
    ...
    @mock.patch("azure.cli.command_modules.appservice.custom._get_scm_url", return_value="https://mock-scm")
    @mock.patch("requests.post", autospec=True)
    def test_enable_zip_deploy_service_unavailable(
        self, requests_post_mock, get_scm_url_mock, get_site_credential_mock
    ):
        # prepare
        cmd_mock = _get_test_cmd()
        cli_ctx_mock = mock.MagicMock()
    ...
    @mock.patch(
        "azure.cli.command_modules.appservice.custom._get_app_settings_from_scm",
        return_value={"SCM_DO_BUILD_DURING_DEPLOYMENT": "true"},
    )
    ...
    def test_add_remote_build_app_settings_add_scm_do_build_during_deployment(
        self,
        ...
        update_app_settings_mock.assert_called_with(
            cmd_mock, "rg", "name", ["SCM_DO_BUILD_DURING_DEPLOYMENT=true"], None
        )
        validate_app_settings_in_scm_mock.assert_called_with(
            cmd_mock, "rg", "name", None, should_contain={"SCM_DO_BUILD_DURING_DEPLOYMENT": "true"}, should_not_have=[]
        )
    ...
    @mock.patch("azure.cli.command_modules.appservice.custom.delete_app_settings")
    @mock.patch(
        "azure.cli.command_modules.appservice.custom.get_app_settings",
        return_value=[
            {"name": "WEBSITE_RUN_FROM_PACKAGE", "value": "https://microsoft.com"},
    ...
    @mock.patch(
        "azure.cli.command_modules.appservice.custom.get_app_settings",
        return_value=[{"name": "SCM_DO_BUILD_DURING_DEPLOYMENT", "value": "false"}],
    )
    ...
    @mock.patch(
        "azure.cli.command_modules.appservice.custom.get_app_settings",
        return_value=[{"name": "SCM_DO_BUILD_DURING_DEPLOYMENT", "value": "true"}],
    )
    ...
    def test_remove_remote_build_app_settings_disable_scm_do_build_during_deployment(
        ...
        # assert
        update_app_settings_mock.assert_called_with(
            cmd_mock, "rg", "name", ["SCM_DO_BUILD_DURING_DEPLOYMENT=false"], None
        )
        validate_app_settings_in_scm_mock.assert_called_with(
            cmd_mock, "rg", "name", None, should_contain={"SCM_DO_BUILD_DURING_DEPLOYMENT": "false"}
        )
