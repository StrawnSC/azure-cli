...
from azure.cli.command_modules.appservice.appservice_environment import (
    show_appserviceenvironment,
...
class AppServiceEnvironmentScenarioMockTest(unittest.TestCase):
    ...
    def test_app_service_environment_show(self, ase_client_factory_mock):
        ...
        host_env = HostingEnvironmentProfile(
            id="/subscriptions/11111111-1111-1111-1111-111111111111/resourceGroups/mock_rg_name/Microsoft.Web/hostingEnvironments/mock_ase_name"
        )
    ...
    def test_app_service_environment_list(self, ase_client_factory_mock):
        ...
        ase_client = mock.MagicMock()
        ase_client_factory_mock.return_value = ase_client
        host_env1 = HostingEnvironmentProfile(
            id="/subscriptions/11111111-1111-1111-1111-111111111111/resourceGroups/mock_rg_name_1/Microsoft.Web/hostingEnvironments/mock_ase_name_1"
        )
        host_env1.name = ase_name_1
        host_env1.kind = "ASEv2"
        host_env2 = HostingEnvironmentProfile(
            id="/subscriptions/11111111-1111-1111-1111-111111111111/resourceGroups/mock_rg_name_2/Microsoft.Web/hostingEnvironments/mock_ase_name_2"
        )
    ...
    @mock.patch(
        "azure.cli.command_modules.appservice.appservice_environment._get_unique_deployment_name", autospec=True
    )
    @mock.patch(
        "azure.cli.command_modules.appservice.appservice_environment._get_resource_client_factory", autospec=True
    )
    @mock.patch(
        "azure.cli.command_modules.appservice.appservice_environment._get_network_client_factory", autospec=True
    )
    @mock.patch("azure.cli.command_modules.appservice.appservice_environment._get_ase_client_factory", autospec=True)
    def test_app_service_environment_create(
        self, ase_client_factory_mock, network_client_factory_mock, resource_client_factory_mock, deployment_name_mock
    ):
        ase_name = "mock_ase_name"
        rg_name = "mock_rg_name"
    ...
    @mock.patch(
        "azure.cli.command_modules.appservice.appservice_environment._get_location_from_resource_group", autospec=True
    )
    @mock.patch("azure.cli.command_modules.appservice.appservice_environment._get_ase_client_factory", autospec=True)
    def test_app_service_environment_update(self, ase_client_factory_mock, resource_group_mock):
        ...
        assert_host_env = HostingEnvironmentProfile(
            id="/subscriptions/11111111-1111-1111-1111-111111111111/resourceGroups/mock_rg_name/Microsoft.Web/hostingEnvironments/mock_ase_name"
        )
        ...
        ase_client.begin_create_or_update.assert_called_once_with(
            resource_group_name=rg_name, name=ase_name, hosting_environment_envelope=assert_host_env
        )
    ...
    def test_app_service_environment_update_asev3(self, ase_client_factory_mock, resource_group_mock):
        ...
        # Assert create_or_update is called with correct properties
        ase_client.update_ase_networking_configuration.assert_called_once_with(
            resource_group_name=rg_name, name=ase_name, ase_networking_configuration=ase_networking_conf
        )
    ...
    @mock.patch("azure.cli.command_modules.appservice.appservice_environment._get_ase_client_factory", autospec=True)
    def test_app_service_environment_v3_create(
        self, ase_client_factory_mock, network_client_factory_mock, resource_client_factory_mock, deployment_name_mock
    ):
        ase_name = "mock_ase_name"
        rg_name = "mock_rg_name"
    ...
    @mock.patch("azure.cli.command_modules.appservice.appservice_environment._get_ase_client_factory", autospec=True)
    def test_app_service_environment_v3_zone_create(
        self, ase_client_factory_mock, network_client_factory_mock, resource_client_factory_mock, deployment_name_mock
    ):
        ase_name = "mock_ase_name"
        rg_name = "mock_rg_name"
